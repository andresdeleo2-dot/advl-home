...
export async function GET() {
  ...
  const [planHistReady, ordenReady, remindReady, comentariosReady, resumenReady, estMinReady] = await Promise.all([
    colReady('plan_hist'), colReady('orden'), colReady('remind_at'), colReady('comentarios'), colReady('resumen'), colReady('est_min'),
  ])
  ...
  return NextResponse.json({ ok: true, data: withTasks, planHistReady, ordenReady, remindReady, comentariosReady, resumenReady, estMinReady, weekBudgetReady })
}
