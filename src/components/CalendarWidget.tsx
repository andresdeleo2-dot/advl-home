...
const srcParams =
  ...
  `&ctz=America%2FMexico_City&bgcolor=%230c1120&showTitle=0&showPrint=0&showCalendars=0&showTz=0`
  ...
  return (
    <div className="flex flex-col rounded-2xl glass overflow-hidden">
      <div className="flex items-center justify-between px-4 pt-3.5 pb-2">
        <p className="text-[10px] font-semibold uppercase tracking-widest text-white/35">Calendario</p>
        <div className="flex items-center gap-1">
          ...
          <a href={`https://calendar.google.com/calendar/u/0/r`} target="_blank" rel="noopener noreferrer"
            ...
            className="ml-0.5 flex h-5 w-5 items-center justify-center rounded-lg text-white/45 hover:bg-white/8">
      ...
      {view === 'agenda' ? (
        <div className="flex flex-col divide-y divide-white/5 overflow-y-auto" style={{ maxHeight: 280 }}>
        ...
        <iframe
          ...
          style={{ height: 320, colorScheme: 'normal' }}
        />
      )}
    </div>
  )
